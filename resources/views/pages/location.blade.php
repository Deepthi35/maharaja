...
<section class="locations-section">
    ...
    <div class="locations-grid">
                ...
                <ul class="location-details">
                    ...
                    <li>
                        ...
                        <div class="detail-content">
                            ...
                            <a href="{{ url('/contact') }}">{!! applicationSettings('opening-hours') !!}</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="detail-content">
                            ...
                            <a href="{{ url('/contact') }}">{!! applicationSettings('map-location') !!}</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="location-card">
            <div class="location-map">
                {!! applicationSettings('location-2-map-iframe') !!}
            </div>
            <div class="location-info">
                @if(!empty($locationsList[1]))
                    <div class="location-badge">
                        <span class="material-symbols-outlined">location_on</span>
                ...
                <ul class="location-details">
                    ...
                    @endif
                    @if(applicationSettings('location-2-opening-hours'))
                    <li>
                        <span class="detail-icon"><span class="material-symbols-outlined">pace</span></span>
                        <div class="detail-content">
                            <span class="detail-label">Opening Hours</span>
                            <a href="{{ url('/contact') }}">{!! applicationSettings('location-2-opening-hours') !!}</a>
                        </div>
                    </li>
                    @endif
                    ...
                    <li>
                        ...
                        <div class="detail-content">
                            <span class="detail-label">Address</span>
                            <a href="{{ url('/contact') }}">{!! applicationSettings('location-2-map-location') !!}</a>
                        </div>
                    </li>
                    @endif
                </ul>

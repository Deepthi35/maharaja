<div class="row form_field_outer_row items_row{{ $i }}">
    ...
    <div class="form-group col-sm-3">
        {!! Form::label('specification_name', 'Specification Name', ['class' => 'span-required']) !!}
        {!! Form::text('specification_name[]', isset($details) && !isset($empty) ? $details->specification_name : null, [
            'class' => 'form-control',
        ]) !!}
    </div>
    ...
    <div class="form-group col-sm-3">
        {!! Form::label('specification_value', 'Specification Value', ['class' => 'span-required']) !!}
        {!! Form::text(
            'specification_value[]',

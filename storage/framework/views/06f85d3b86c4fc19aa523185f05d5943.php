        ...
        <div class="col-md-10">
            <div class="contact-section bg-primary card-body text-light">
                ...
                <div class="text-left mb-4">
                    <h2 class="h5 get-in-title"><?php echo applicationSettings('catering-contact-text'); ?></h2>
                </div>

                <form action="<?php echo e(url('catering-form-submission')); ?>" method="POST" id="contact-form">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\Users\DELL\OneDrive\Desktop\maharaja\resources\views/pages/catering-form.blade.php ENDPATH**/ ?>
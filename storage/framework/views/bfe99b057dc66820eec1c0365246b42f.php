                            ...
                            <div class="h-100 vintage-right-pic">
                                <div class="card card-body h-100 bg-primary border-radius-0 text-center">
                                    ...
                                    <div class="contact-loc-name">
                                        <a href="tel:+1 402-505-4488" class="my-1 btn btn-outline-white"><img src="<?php echo e(asset('frontend/img/icons/interface/phone1.svg')); ?>" alt="Phone icon" class="phone-icon pr-1">OMAHA</a>
                                        <a href="tel:+1 531-207-1921" class="btn btn-outline-white"><img src="<?php echo e(asset('frontend/img/icons/interface/phone1.svg')); ?>" alt="Phone icon" class="phone-icon pr-1">PAPILLION </a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/test/maharaja/resources/views/pages/index.blade.php ENDPATH**/ ?>